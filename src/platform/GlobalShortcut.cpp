...
QString GlobalShortcut::sequence() const {
    return sequence_;
}
QString GlobalShortcut::error() const {
    return error_;
}
bool GlobalShortcut::registered() const {
    return registered_;
}
QString GlobalShortcut::description() const {
    return description_;
}
bool GlobalShortcut::pending() const {
    return !pendingSequence_.isEmpty();
}
void GlobalShortcut::completeRegistration(bool success, const QString &error,
